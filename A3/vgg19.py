...
class Vgg19:
    ...
    def build(self, rgb, train_mode=None):
        ...
        self.fc8 = self.fc_layer(self.relu7, 4096, 8, "fc8_8")
...
#        print("var.get_shape:{0}".format(var.get_shape()))
#       print("initial_value.get_shape:{0}:".format(initial_value.get_shape()))
