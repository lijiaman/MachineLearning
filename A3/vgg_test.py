   ...
   # t_train = t_train[rnd_idx]
    for step in xrange(num_steps):
       ...
       # t_batch = t_train[start: end]
        x_batch, t_batch = random_input.load_batchsize_images(32)
...
#        t_val_batch = t_val[val_start: val_end]
        x_val_batch, t_val_batch = random_input.load_val_images(32)
    ...
    if epoch + 1 == 1 or (epoch + 1) % print_freq == 0:
		...
		w_f.close()
        network.save_npy(sess=sess, npy_path="/ais/gobi4/fashion/scene_vgg.npy")
